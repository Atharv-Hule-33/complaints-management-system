...
public class ComplaintTypeControllerTest {
    ...
    public void getComplaintTypeByIdTest() {
        ...
        ResponseEntity<ComplaintType> response = complaintTypeController.getComplaintTypeById(1L);
    ...
    public void getComplaintTypesBySeverityTest() {
        ...
        ResponseEntity<List<ComplaintType>> response = 
            complaintTypeController.getComplaintTypesBySeverity(ComplaintSeverity.HIGH);
